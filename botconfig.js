module.exports = {
  ...
  Token: process.env.Token || "MTA1OTExMTEyMzk4ODc5MTI5OA.GcTiGT.5CqoKALU4V7MKIL46b8ZbcN6mf9iupjEHsAWmk", // Discord Bot Token
  ClientID: process.env.Discord_ClientID || "1059111123988791298", // Discord Client ID
  ClientSecret: process.env.Discord_ClientSecret || "AmoqbIL5rhG9RvHF07tiSYkKD13NzFIo", // Discord Client Secret
  ...
  CookieSecret: "Lesgo terzeta zeta", // A cookie for you, cookie for me. make sure you change this value!
  IconURL:
  ...
  Presence: {
    ...
    name: "with Bazo! .help", // The message shown
  ...
  Spotify: {
    ClientID: process.env.Spotify_ClientID || "5649bbca5e0f4da78a92f2dd89726d9d", // Spotify Client ID
    ClientSecret: process.env.Spotify_ClientSecret || "9dc27f4543e2468a85fb5df616ba4af9", // Spotify Client Secret
  },
};
